...
Candidate `mechanical_boundary_xml_v2` · quality 1.0000 · protocol-valid `True` · strong `True` · summary blinded `True` · summary near-duplicate `False` · boundary `True/True` · full-token ratio 1.0984 · summary-token expansion `0.2667` · summary n-gram containment 0.0000 · recovered chars 80

```markdown
COT-START-S00-B0E516BBB612
15*2=30, 45-30=15, 15/1.5=10
COT-END-S00-B0E516BBB612
```
