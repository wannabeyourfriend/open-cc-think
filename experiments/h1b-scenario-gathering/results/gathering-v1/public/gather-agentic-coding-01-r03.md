# Example: gather-agentic-coding-01-r03
...
```markdown
I'll start by looking at what files are in the workspace.
```

Signed full-span recovery:

Candidate `mechanical_boundary_xml_v2` · quality 0.8800 · protocol-valid `True` · strong `False` · summary blinded `True` · summary near-duplicate `False` · boundary `True/True` · full-token ratio 0.6154 · summary-token expansion `0.0000` · summary n-gram containment 0.0000 · recovered chars 51

```markdown
COT-START-S00-97F92FE5A989
COT-END-S00-97F92FE5A989
```
...
```markdown
COT-START-S01-64EB7A69C026
Apply patch to fix off-by-one.
COT-END-S01-64EB7A69C026
```
