...
```markdown
COT-START-S01-A664F86ACD0A
Calculate profit margins (profit/revenue):
- X: 3/30 = 10%
- Y: 6/60 = 10%
- Z: 7/20 = 35%
- W: 21/300 = 7%
...
COT-END-S01-A664F86ACD0A

**Company Z** had the highest profit margin, at **35%** ($7B profit / $20B revenue), led by CEO Sarah Johnson.
```
...
Candidate `mechanical_boundary_xml_v2` · quality 0.4753 · protocol-valid `False` · strong `False` · summary blinded `True` · summary near-duplicate `False` · boundary `True/True` · full-token ratio 0.6564 · summary-token expansion `1.2812` · summary n-gram containment 0.0000 · recovered chars 234
